...
func TestSerialiseRecordWithCompleteRecord(t *testing.T) {
	...
	_ = r.SetSummary(NewSummary("This is a\nmultiline summary"))
	r.AddRange(Ɀ_Range_(Ɀ_Time_(8, 00), Ɀ_Time_(12, 15)), NewSummary("Foo"))
	r.AddDuration(NewDuration(2, 15), NewSummary("Bar"))
	_ = r.StartOpenRange(Ɀ_Time_(14, 38), NewSummary("Baz"))
	r.AddDuration(NewDuration(-1, -51), NewSummary())
	r.AddRange(Ɀ_Range_(Ɀ_TimeYesterday_(23, 23), Ɀ_Time_(4, 3)), NewSummary())
	r.AddRange(Ɀ_Range_(Ɀ_Time_(22, 0), Ɀ_TimeTomorrow_(0, 1)), NewSummary())
