...
type Style struct {
	...
	DateFormat     styleProp[klog.DateFormat]
	TimeFormat     styleProp[klog.TimeFormat]
...
func Elect(base Style, parsedRecords []ParsedRecord) *Style {
	...
	dateFormatElection := newElection[klog.DateFormat]()
	timeFormatElection := newElection[klog.TimeFormat]()
	...
	return &Style{
		...
		ascertain[klog.DateFormat](&dateFormatElection, base.DateFormat),
		ascertain[klog.TimeFormat](&timeFormatElection, base.TimeFormat),
