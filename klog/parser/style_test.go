...
func TestDefaultStyle(t *testing.T) {
	assert.Equal(t, &Style{
		...
		DateFormat:     styleProp[klog.DateFormat]{klog.DateFormat{UseDashes: true}, false},
		TimeFormat:     styleProp[klog.TimeFormat]{klog.TimeFormat{Use24HourClock: true}, false},
...
func TestDetectsStyleFromMinimalFile(t *testing.T) {
	...
	assert.Equal(t, &Style{
		LineEnding:     styleProp[string]{"\n", false},
		Indentation:    styleProp[string]{"    ", false},
		DateFormat:     styleProp[klog.DateFormat]{klog.DateFormat{UseDashes: true}, true},
		TimeFormat:     styleProp[klog.TimeFormat]{klog.TimeFormat{Use24HourClock: true}, false},
		SpacingInRange: styleProp[string]{" ", false},
	}, rs[0].Style)
}
...
func TestDetectCanonicalStyle(t *testing.T) {
	...
	assert.Equal(t, &Style{
		...
		DateFormat:     styleProp[klog.DateFormat]{klog.DateFormat{UseDashes: true}, true},
		TimeFormat:     styleProp[klog.TimeFormat]{klog.TimeFormat{Use24HourClock: true}, true},
...
func TestDetectsCustomStyle(t *testing.T) {
	...
	assert.Equal(t, &Style{
		LineEnding:     styleProp[string]{"\r\n", true},
		Indentation:    styleProp[string]{"\t", true},
		DateFormat:     styleProp[klog.DateFormat]{klog.DateFormat{UseDashes: false}, true},
		TimeFormat:     styleProp[klog.TimeFormat]{klog.TimeFormat{Use24HourClock: false}, true},
		SpacingInRange: styleProp[string]{"", true},
	}, rs[0].Style)
}
